...
**Remember**: You will still need to go through the whole deploy process at least once *with* `sudo` enabled. This only allows for *ongoing* deploys without using `sudo`.
